...
#'Class \code{"adjust_lmList"}
#'
#'Adjusted List of \code{lm} Objects with a Common Model
#'
#'
#'@name adjust_lmList-class
#'@aliases adjust_lmList-class formula,adjust_lmList-method
#'coef,adjust_lmList-method confint,adjust_lmList-method
#'show,adjust_lmList-method plot,adjust_lmList.confint,ANY-method
#'@docType class
#'@section Objects from the Class: Objects can be created by calls of the form
#'\code{new("adjust_lmList", ...)} or by \code{adjust_lmList}.
#'@keywords classes
NULL
...
#'\item{hgc.9}{hgc - 9, a centered version of hgc} \item{uerate}{ocal area
#'unemployment rate for that year} \item{ue.7}{} \item{ue.centert1}{}
#'\item{ue.mean}{} \item{ue.person.cen}{} \item{ue1}{} }
#'@references Singer, J. D. and Willett, J. B. (2003), \emph{Applied
#'Longitudinal Data Analysis: Modeling Change and Event Occurence}, New York:
#'Oxford University Press.
#'
#'Cook, D. and Swayne, D. F. (2007), \emph{Interactive and Dynamic Graphics for
#'Data Analysis with R and GGobi}, Springer.
#'@source These data are originally from the 1979 National Longitudinal Survey
#'on Youth (NLSY79) that can be found here
#'\url{http://www.bls.gov/nls/nlsdata.htm}.
#'
#'Singer and Willett (2003) used these data for examples in chapter (insert
#'info. here) and the data sets used can be found on the UCLA Statistical
#'Computing website: \url{http://www.ats.ucla.edu/stat/examples/alda/}
#'
#'Additionally the data were discussed by Cook and Swayne (2003) and the data
#'can be found on the GGobi website: \url{http://www.ggobi.org/book/}.s
#'@examples
#'
#'str(wages)
#'summary(wages)
