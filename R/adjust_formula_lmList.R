...
#' however, \code{adjust_lmList} can handle models where a factor takes only
#' one level within a group. In this case, the \code{formula} is updated
#' eliminating the offending factors from the formula for that group as the
#' effect is absorbed into the intercept.
#' 
#' 
