...
#' @param group a logical value used whether a group of observations or
#' individual observations will be deleted. If this is left \code{FALSE}, then
#' the function will delete individual observations.
...
#' deletion
#' @return ranef.delete a list of the random effects obtained through case
#' deletion
#' @return vcov.delete a list of the variance-covariance parameters
#' obtained through case deletion
#' @return fitted.delete a list of the fitted values obtained through case
#' deletion
#' @return varcomp.delete a list of the variance components obtained
