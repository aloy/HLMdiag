...
* `data` - only necesarry if `na.action = na.exclude` for a `lmerMod` model object. `data` should specify the data frame used to fit the model containing observations with `NA` values.
...
Adam Loy, Heike Hofmann (2014). HLMdiag: A Suite of Diagnostics for Hierarchical
  Linear Models in R. Journal of Statistical Software, 56(5), 1-28. URL
...
Jose Pinheiro, Douglas Bates, Saikat DebRoy, Deepayan Sarkar, {R Core Team}} (2020). 
  _nlme: Linear and Nonlinear Mixed Effects Models_. R package version 3.1-148, 
...
West, B., Welch, K. & Galecki, A. (2006) Linear Mixed Models: A Practical Guide
