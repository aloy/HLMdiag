...
To explore the functionality of `hlm_influence()`, we will use the dataset `classroom` (**West et. al, 2014**). The data set consists of 1,190 observations of students. Students are grouped within classes, which are nested within schools. There are 312 distinct classes nested within 107 schools. 
