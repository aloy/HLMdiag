...
Up to now diagnostics for mixed and hierarchical models has relied on much programming by the analyst, especially if one desires influence diagnostics. To help fill this need, `HLMdiag`:
