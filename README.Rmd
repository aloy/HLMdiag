...
```
<!-- badges: start -->
[![R-CMD-check](https://github.com/aloy/HLMdiag/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/aloy/HLMdiag/actions/workflows/R-CMD-check.yaml)
